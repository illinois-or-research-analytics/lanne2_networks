...
def main(edge_input: str = typer.Option(..., "--filepath", "-f"),
    ...
    out_edge_file = os.path.join(output_dir, f'syn_o_un.tsv')

    log_path = os.path.join(output_dir, f'outliers_un.log')
    ...
    try:
        ...
        for v in unclustered_nodes:
            ...
            # Only difference between Outliers as Cluster and Outliers in its own cluster
            new_cluster_id += 1
