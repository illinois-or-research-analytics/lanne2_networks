...
def main(edge_input: str = typer.Option(..., "--filepath", "-f"),
    ...
    out_edge_file = os.path.join(output_dir, f'syn_o_gs.tsv')

    log_path = os.path.join(output_dir, f'outliers_gs.log')
    ...
    try:
        ...
        if num_o_edges_within_o > 0:
            ...
            print("Final number of edges in output graph : ",(len(N_edge_list) - len(N_o_self_loops)))
