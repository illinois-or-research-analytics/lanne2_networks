...
import reccs_phase2_version2 as reccs_v2
...
def main(edge_input: str = typer.Option(..., "--filepath", "-f"),
    ...
    try:
        ...
        start_time = time.time()
        reccs_v2.main(edge_input=out_edge_file3, cluster_input=cluster_input,out_edge_file=out_edge_file5,emp_edge_input=emp_edge_input)
        logging.info(f"Time taken: {round(time.time() - start_time, 3)} seconds")
