...
def main(edge_input: str = typer.Option(..., "--filepath", "-f"),
    ...
    out_edge_file = out_edge_file.replace("SBM_plusedges_rep","SBM_mcs_rep")
    ...
    out_edge_file3 = out_edge_file.replace('SBM_mcs','SBM_mcs_wellconnected')
    ...
    log_path = f'SubNetworks_SBMMCS_plusedges_logs_allstages/{net_name}_mcs.log'
    ...
    try:
        ...
        logging.info("Compute cluster stats for graph! - G")
        start_time = time.time()
