...
def main(edge_input: str = typer.Option(..., "--filepath", "-f"),
    ...
    logging.basicConfig(filename=f'SBM_twostep_outlier_addition_V1_samples/{net_name}/SBM_twostep_outlier_addition_V1_samples.log', filemode='w', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
    ...
    try:
        ...
        print("Number of outlier edges added into clusters: ", count, N_c_num_edges,len(N_edge_list))
        print("Number of outlier edges to be added within outliers: ", (G.numberOfEdges() - G_c.numberOfEdges() - count))
