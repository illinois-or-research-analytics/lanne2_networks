...
def get_graph_stats(graph, outlier_nodes, stage, node_mapping):
    ...
    isolated_vertices = get_isolated_vertices(graph)
    ...
    stats[f'degree_dist_{stage}'] = np.array(degree_stats)
    outlier_degrees = []
    ...
    if len(outlier_nodes)>0:
        ...
        stats[f'outlier_degree_dist_{stage}'] = outlier_degree_stats
        stats[f'outlier_edges_{stage}'] = outlier_edges//2
    else:
        stats[f'outlier_degree_dist_{stage}'] = []
